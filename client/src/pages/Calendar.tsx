...
export default function CalendarPage() {
  ...
  useEffect(() => { document.title = 'Calendar — Trackr'; }, []);
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch((err) => { console.error('Failed to load calendar interviews', err); setError('Failed to load interviews'); })
    ...
    <div className="min-h-screen p-6 space-y-6 pb-24 md:pb-6">
      ...
      <div className="pt-2 flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold text-gray-800 min-w-[140px] text-center" aria-live="polite">
