...
export default function ApplicationCard({ application, onEdit, onDelete, dragging, hasInterview = false, contactName = null }) {
    ...
    >
      <div className="flex justify-between items-start gap-2">
        <div className="flex-1 min-w-0">
          ...
          {contactName && <p className="text-sm text-gray-400 mt-0.5 truncate">👤 {contactName}</p>}
        </div>
